...
class Cart extends Model{
    ...
    public function get(int $idcart){
        ...
        $results = $sql->select("CALL sp_carts_save (:idcart, :dessessionsid, :iduser, :deszipcode, :vlfreight, :nrdays)", [
            ':idcart'=> $this->getidcart(),
            ':dessessionsid'=>$this->getdessessionid(),
    ...
    public function getProducts(){
        ...
        return Product::checkList($sql->select("
                      SELECT b.idproduct, b.desproduct, 
                      b.vlprice, b.vlwidth, b.vlheight, b.vllength, b.vlweight, b.desurl, 
