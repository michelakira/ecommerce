...
class User extends Model{
    ...
    public static function checkLogin($inadmin = true){
                  ...
                  !(int)$_SESSION[User::SESSION]["iduser"] > 0 )
        {
            ...
            if($inadmin === true && (bool)$_SESSION[User::SESSION]['indamin'] === true)
            {
                return true;
            }
        ...
        else
        {
            ...
            else
            {
                ...
                if (in_array($cipher, openssl_get_cipher_methods())) 
                {
                    ...
                    $code = base64_encode(openssl_encrypt($plaintext, $cipher, $dataRecovery["idrecovery"], $options=0, $iv, $tag));
                }
                */
                ...
                $email = new Mailer($data["desemail"], $data["desperson"], "Redefinir senha", "forgot", 
                        array(
                            "name"=>$data["desperson"],
                            "link"=>$link
                ));
